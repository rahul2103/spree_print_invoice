im = (Rails.application.assets || ::Sprockets::Railtie.build_environment(Rails.application)).find_asset(@doc.print_invoice_setting.logo_path)

if im && File.exist?(im.pathname)
  pdf.image im.filename, vposition: :top, height: 40, scale: @doc.print_invoice_setting.logo_scale
end
