  ...
  module Admin
    module MainMenu
      class PrintInvoiceBuilder
        ...
        def build
          items = [
            ::Spree::Admin::MainMenu::ItemBuilder.new('invoices',
                                                      ::Spree::Core::Engine.routes.url_helpers.admin_bookkeeping_documents_path(q: { template_eq: 'invoice' }))
                                                 ...
                                                 .build,
            ::Spree::Admin::MainMenu::ItemBuilder.new('packaging_slips',
                                                      ::Spree::Core::Engine.routes.url_helpers.admin_bookkeeping_documents_path(q: { template_eq: 'packaging_slip' }))
